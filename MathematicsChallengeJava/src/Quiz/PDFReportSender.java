...
public class PDFReportSender {
    ...
    public static void sendPDFReport(String recipientEmail, String subject, String body, String pdfFilePath) {
        ...
        final String username = "YOUR_MAILTRAP_USERNAME"; // Replace with your actual Mailtrap username
        final String password = "YOUR_MAILTRAP_PASSWORD"; // Replace with your actual Mailtrap password
